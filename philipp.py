...
champions = ['Азира', 'Акали', 'Алистара', 'Амуму', 'Анивию', 'Ари', 'Атрокса', 'Аурелион Сола', "Афелия",
	...
	"Владимира", "Волибира", "Вукнога", "Галио", "Гангпланка", "Гарена", "Гекарима :horse_racing_tone1:", "Гнара", 
	...
	"ЧоГата", "Шако", "Шаю", "Шена", "Шивану", "Эвелинн", "Эзреаля", "Экко", "Элизу", "Энни", "Эш", "Юми :smirk_cat:", 
