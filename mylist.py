...
first_half = ["Буйный", "Дикий", "Гнойный", "Хромой", "Убитый", "Спидозный", "Ролевой", "Крытый", "Мышиный", "Чикибамбони", "Чотырнутый",
	"Магический", "Нетрезвый", "Рандомный", "Дерзкий", "Вареный", "Маленький", "Пушистый", "Белый", "Бешеный", "Сексуальный", "Простой",
	"Кровавый", "Похотливый", "Агрессивный", "Уютный", "Коллективный", "Детский", "Универсальный", "Этнический", "Решающий", "Скучный", 
	"Молодой", "Рациональный", "Ядерный", "Крохотный", "Уличный", "Смешной", "Частный", "Учебный", "Жидкий", "Верный", "Хрупкий", 
	"Честный", "Яркий", "Смелый", "Холодный", "Фундаментальный", "Либеральный", "Искренний", "Багровый"]
second_half = ["Столяр", "Насос", "Мышь", "Чикибамбони", "Ясуо", "Сокрушитель", "Экскурсовод", "Убийца", "Воин", "Растворитель", "Форшмак",
	"Индеец", "Хлеб", "Голубец", "Блинчик", "Цезарь", "Бургер", "Багет", "Милашка", "Собутыльник", "Хокаге", "Враг", "Физрук", "Волк",
	"Неонацист", "Орёл", "Ананас", "Пингвин", "Чебурек", "Глушитель", "Мейнер", "Вампир", "Камыш", "Дуб", "Верблюд", "Дебил", "Грешник",
	 "Дятел", "Лоликонщик", "Автобус", "Гризли", "Машинист", "Ли Син", "Картофель", "Патриот", "Любимчик", "Извращенец", "Лекарь", "Танцор",
	 "Гаврила", "Гей"]
